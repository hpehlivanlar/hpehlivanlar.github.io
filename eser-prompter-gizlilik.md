...
Uygulama, kullanıcının açık seçimiyle belge veya metin dosyalarının içe aktarılmasına izin verebilir.
...
Kullanıcı izinleri iPhone ayarlarından istediği zaman değiştirebilir:

```text
iPhone Ayarlar > Gizlilik ve Güvenlik > Kamera
iPhone Ayarlar > Gizlilik ve Güvenlik > Mikrofon

5. Fotoğraf arşivi erişimi
Kullanıcı bir kayıt veya görseli Fotoğraflar uygulamasına kaydetmek istediğinde fotoğraf arşivi izni istenebilir.

Uygulama, kullanıcının izni olmadan fotoğraf arşivini taramaz veya içerikleri geliştiriciye göndermez.
...
Apple hesabı parolasını,

Ödeme bilgilerinin tamamını

göremez veya saklayamaz.
...
Kullanıcıları uygulamalar arasında takip etmez.
