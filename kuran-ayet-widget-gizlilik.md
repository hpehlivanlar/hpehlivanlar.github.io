---
layout: page
title: Kuran Ayet Widget Gizlilik Politikası
...
Kuran Ayet Widget; Kur'an-ı Kerim ayetlerini, Türkçe meallerini, sure ve ayet bilgilerini uygulama içerisinde ve iOS widget alanlarında göstermeyi amaçlayan bir mobil uygulamadır.

## 2. Toplanan kişisel bilgiler

Kuran Ayet Widget uygulaması kullanıcıdan doğrudan aşağıdaki kişisel bilgileri talep etmez:
...
Kullanıcı verileri satılmaz, kiralanmaz veya reklam amacıyla üçüncü taraflara aktarılmaz.

## 3. Cihazda saklanan bilgiler

Aşağıdaki bilgiler kullanıcının cihazında yerel olarak saklanabilir:

- Widget tercihleri
- Yazı boyutu ve görünüm ayarları
- Tema tercihleri
- Favori ayetler
- Son görüntülenen ayet
- Bildirim tercihleri
- Premium erişim durumu

Bu bilgiler geliştiricinin sunucularına gönderilmez ve kullanıcıyı kişisel olarak tanımlamak amacıyla kullanılmaz.

Uygulamanın cihazdan kaldırılması durumunda, iOS tarafından saklanan yerel uygulama verileri de silinebilir.

## 4. İnternet bağlantısı ve ayet hizmetleri

Uygulama, ayet metinlerini ve Türkçe mealleri alabilmek için internet üzerinden Kur'an içeriği sağlayan servislerle iletişim kurabilir.

İnternet bağlantısı sırasında ilgili hizmet sağlayıcı tarafından aşağıdaki teknik bilgiler işlenebilir:

- IP adresi
- İstek tarihi ve saati
- İstenen ayet veya sure bilgisi
- Sunucu güvenlik kayıtları
- Teknik hata kayıtları

Bu bilgiler hizmet sağlayıcının kendi gizlilik politikası kapsamında işlenebilir.

## 5. Widget kullanımı

Uygulama, iOS ana ekranında ve kilit ekranında ayet göstermek amacıyla widget desteği sunabilir.

Widget içerisinde gösterilecek bilgiler, Apple tarafından sağlanan güvenli uygulama grubu veya yerel veri paylaşım yöntemleri kullanılarak uygulama ile widget arasında aktarılabilir.

Bu bilgiler geliştirici sunucularına aktarılmaz.

## 6. Bildirimler

Uygulama günlük ayet veya hatırlatma bildirimleri gönderebilir.
